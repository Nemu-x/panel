...
def upgrade() -> None:
    ...
    with op.batch_alter_table('hosts', schema=None) as batch_op:
        batch_op.add_column(sa.Column('wireguard_amazia', sa.JSON(none_as_null=True), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('hosts', schema=None) as batch_op:
        batch_op.drop_column('wireguard_amazia')
